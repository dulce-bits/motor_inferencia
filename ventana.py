...
#   Fecha: 30/05/2019
#   Descripcion: Este script almacena unicamente lo gráfico a mostrarse en el motor de inferencia


#Importar lo necesario para mostrar los gráficos
...
class Aplicacion:
    def __init__(self):
        ...
        self.scrolledtext2 = st.ScrolledText(self.ventana1, width=80, height=20)
